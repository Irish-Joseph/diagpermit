...
completed before public launch, and legal advice should be obtained if the
project becomes commercially significant.
...
## Rules (pending finalization)

1. The official name and logo may be used factually to describe
   compatibility or forking.
...
5. Conformance: implementations running the published conformance suite may
   describe themselves as conformance-tested, and must link the specific
   protocol version and vector set.

Questions about this policy go through GitHub issues.
